...
if __name__ == "__main__":
    ...
    execute_per_strain_nucleotide_enrichment_pipeline(own_synthetic=True, save_plots=True, debug=False, force_recreate=False, seg_sample_size=35000, multi_source=True)
